...
export const delegate =
  /**
   * @type {{
   *   (rootElement: (HTMLElement|document|window), element: (HTMLElement|string), type: string, fn: EventListener, options?: boolean | AddEventListenerOptions): ReturnType<addEventListener>;
   *   (rootElement: (HTMLElement|string), element: string, type: EventListener, fn?: boolean | AddEventListenerOptions): ReturnType<addEventListener>;
   * }}
   */
