...
describe('date', function() {
  ...
  it('should format year', function() {
    ...
    expect(strftime(timestampbc31, 'yyyy', offset)).toEqual('0031');
    expect(strftime(timestampbc02, 'yyyy', offset)).toEqual('0002');
    expect(strftime(timestamp0000, 'yyyy', offset)).toEqual('0001');
    ...
    expect(strftime(timestampbc31, 'yy', offset)).toEqual('31');
    expect(strftime(timestampbc02, 'yy', offset)).toEqual('02');
    expect(strftime(timestamp0000, 'yy', offset)).toEqual('01');
    ...
    expect(strftime(timestampbc31, 'y', offset)).toEqual('31');
    expect(strftime(timestampbc02, 'y', offset)).toEqual('2');
    expect(strftime(timestamp0000, 'y', offset)).toEqual('1');
