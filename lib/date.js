...
const DATE_FORMATS_SPLIT = /((?:[^yMLdHhmsSaZEwG']+)|(?:'(?:[^']|'')*')|(?:E+|y+|M+|L+|d+|H+|h+|m+|s+|S+|a|Z|G+|w+))(.*)/;
...
const DATE_FORMATS = {
  ...
  S: (date) => String(date.getMilliseconds()).padStart(3, '0').slice(0, 1),
  SS: (date) => String(date.getMilliseconds()).padStart(3, '0').slice(0, 2),
  SSS: (date) => String(date.getMilliseconds()).padStart(3, '0'),
  SSSS: (date) => String(date.getMilliseconds()).padStart(3, '0').padEnd(4, '0'),
  SSSSS: (date) => String(date.getMilliseconds()).padStart(3, '0').padEnd(5, '0'),
  SSSSSS: (date) => String(date.getMilliseconds()).padStart(3, '0').padEnd(6, '0'),
