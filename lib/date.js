...
/**
 * @typedef {({MONTH: [ string, string, string, string, string, string, string, string, string, string, string, string ], SHORTMONTH: string[], WEEKENDRANGE: number[], FIRSTDAYOFWEEK: number, medium: string, ERANAMES: [string, string], AMPMS: [string, string], STANDALONEMONTH: string[], fullDate: string, mediumDate: string, mediumTime: string, shortTime: string, longDate: string, short: string, SHORTDAY: string[], DAY: string[], shortDate: string, ERAS: [string, string]} & Object<string,*>)} DateTimeLocale
 */
/**
 * @type {DateTimeLocale}
 */
 ...
 */
/**
 * @description Parse string to Date if it match passed date format otherwise returns null
  ...
  while (parsedFormat && dateStr) {
    ...
    if (partName) {
      ...
      if (part === 'y' || part === 'yy') {
        ...
        const dateIndex = DATE_FORMAT_TO_STRING[part].indexOf(value);
    ...
    dateStr = dateStr.substr(pmatch[0].length);
  }
...
function dateGetter(/**@type {any}*/name, /**@type {any}*/size, /**@type {any}*/offset, /**@type {any}*/trim, /**@type {any}*/negWrap) {
  offset = offset || 0;
  return function(/**@type {any}*/date) {
...
function dateStrGetter(/**@type {any}*/name, /**@type {any}*/shortForm, /**@type {any}*/standAlone) {
  return function(/**@type {any}*/date, /**@type {any}*/formats) {
