/**
 * @type {{MONTH: [ string, string, string, string, string, string, string, string, string, string, string, string ], SHORTMONTH: string[], WEEKENDRANGE: number[], FIRSTDAYOFWEEK: number, medium: string, ERANAMES: [string, string], AMPMS: [string, string], STANDALONEMONTH: string[], fullDate: string, mediumDate: string, mediumTime: string, shortTime: string, longDate: string, short: string, SHORTDAY: string[], DAY: string[], shortDate: string, ERAS: [string, string]}}
 */
