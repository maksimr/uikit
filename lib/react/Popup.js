...
function calcPositionForBestDirection(
  ...
  const scrollableRect = scrollableNode.getBoundingClientRect().toJSON();
  // getBoundingClientRect returns incorrect values for height and bottom of
  // html element
  if (scrollableNode.nodeType === 1) {
    scrollableRect.height = scrollableNode.clientHeight;
    scrollableRect.bottom = scrollableRect.height - scrollableNode.scrollTop;
  }
  let pos = null;
