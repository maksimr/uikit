...
export function PopupPortal({
   ...
   * @type {HTMLElement}
   */
  const positionedNode = useMemo(() => parentNode || popupConfig?.parentNode || findPositionedElement(anchorNode?.parentNode) || document.body, [anchorNode, parentNode, popupConfig?.parentNode]);
  /**
