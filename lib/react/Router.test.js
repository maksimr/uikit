...
describe('Router', function() {
  it('should render matched route', function() {
    const User = jasmine.createSpy().and.returnValue('Hello World!');
  ...
  it('should allow pass a function to route', function() {
    const userRouteFn = jasmine.createSpy().and.returnValue(<div>Hello World!</div>);
  ...
  it('should call otherwise', function() {
    const User = jasmine.createSpy().and.returnValue('Hello World!');
    const otherwise = jasmine.createSpy().and.returnValue(null);
