...
/**
 * @param {number} year 
 * @returns {boolean} returns true if year is leap
 */
 ...
 * If we failed extract timezone offset we return current local offset
 * @param {Date} date
 * @param {string} timeZone
 * @returns {number}
 */
export function dateTimeZoneOffset(date, timeZone) {
